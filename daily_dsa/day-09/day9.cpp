...
class Solution {
    public:
        bool isPowerOfThree(int n) {
            return isPowerOfThree_03(n);    // 140ms
            return isPowerOfThree_02(n);    // 130ms
            return isPowerOfThree_01(n);    // 140ms
            return isPowerOfThree_recur(n); // 136ms
            return isPowerOfThree_loop(n);  // 168ms
        }
